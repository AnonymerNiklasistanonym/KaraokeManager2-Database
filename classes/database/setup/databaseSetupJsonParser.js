...
class DatabaseTablesJsonParser {
   ...
   * @returns {Promise<import('../databaseTypes2').IJsonDataTable[]>} The parsed JSON object
   */
...
class DatabaseTableValuesJsonParser {
  ...
  /**
   * Parse JSON file to JSON object
   * @returns {Promise<import('../databaseTypes2').IJsonDataDefaultValues>} The parsed JSON object
   */
