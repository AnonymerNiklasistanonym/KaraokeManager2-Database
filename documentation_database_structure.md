...
- is_admin (`boolean/integer`) [*NOT NULL*]<br>*indicates if account has elevated admin rights*
...
- is_private (`boolean/integer`) [*NOT NULL*]<br>*indicates if account should be hidden on public page*
- is_banned (`boolean/integer`) [*NOT NULL*]<br>*indicates if account is banned*
- is_banned_comments (`boolean/integer`) [*NOT NULL*]<br>*indicates if account is banned in writing comments*
- is_banned_entries (`boolean/integer`) [*NOT NULL*]<br>*indicates if account is banned in creating new (playlist) entries*
...
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when artist was added*
...
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when song content type was added*
...
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when song language was added*
...
- song_content_type (`integer`)<br>*song content type (Music video, audio file, ...)*
   - *reference to* song_content_type.id
- song_content_language (`integer`)<br>*language of the song*
   - *reference to* song_content_language.id
...
- artist (`integer`) [*NOT NULL*]<br>*artist which sings the connected song*
   - *reference to* artist.id
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when tag was created*
...
- id (`integer`) [**PRIMARY KEY**, *NOT NULL*, *UNIQUE*]<br>*unique id*
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when playlist_entry was added*
...
- id (`integer`) [**PRIMARY KEY**, *NOT NULL*, *UNIQUE*]<br>*unique id*
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when join to playlist_entry was added*
- playlist_entry (`integer`) [*NOT NULL*]<br>*playlist entry that the author account wants to join*
   - *reference to* playlist_entry.id
...
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when album was created*
...
- id (`integer`) [**PRIMARY KEY**, *NOT NULL*, *UNIQUE*]<br>*unique id*
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when image was added*
- author (`text`) [*NOT NULL*]<br>*account that added the image*
   - *reference to* account.id
- server_file_path (`text`) [*NOT NULL*]<br>*server file path of image*
- is_private (`boolean/integer`) [*NOT NULL*]<br>*indicates if image is private*
- name (`text`)<br>*name of the image*
- description (`date/DATETIME`)<br>*description of the image*
...
- id (`integer`) [**PRIMARY KEY**, *NOT NULL*, *UNIQUE*]<br>*unique id*
- date (`date/DATETIME`) [*NOT NULL*]<br>*date when comment was made*
...
- reply (`integer`)<br>*this comment was an answer to another comment*
   - *reference to* artist_comment.id
...
- message (`text`) [*NOT NULL*]<br>*comment text*
- reply (`integer`)<br>*this comment was an answer to another comment*
   - *reference to* account_comment.id
...
- message (`text`) [*NOT NULL*]<br>*comment text*
- reply (`integer`)<br>*this comment was an answer to another comment*
   - *reference to* playlist_entry_comment.id
...
- album (`integer`) [*NOT NULL*]<br>*album on which the comment was made*
   - *reference to* album.id
- author (`text`) [*NOT NULL*]<br>*account that created this comment*
   - *reference to* account.id
- message (`text`) [*NOT NULL*]<br>*comment text*
- reply (`integer`)<br>*this comment was an answer to another comment*
   - *reference to* image_album_comment.id
